// Using the link HERE , copy the array of JSON objects containing countries with their populations.
//  Display in an object showing how many countries have population between 0 - 50m, 51m - 100m, > 100m as the keys
...
const pop_value = { "0-50m": 0, "51-100m": 0, ">100m": 0 }

for (let i = 0; i < pops.length; i++) {
    const pop = pops[i].population

    if (pop <= 50000000) { pop_value["0-50m"]++; }
    else if (pop <= 100000000) { pop_value["51-100m"]++; }
    else { pop_value[">100m"]++; }
}
...
//   a)PostgreSQL
console.log(company.departments[0].employees[1].skills[2])  // Output: PostgreSQL

//   b)Brand Strategy
console.log(company.departments[1].employees[1].skills[2])  // Output: Brand Strategy

//   c)React
console.log(company.departments[0].employees[0].skills[1])  // Output: Brand Strategy
